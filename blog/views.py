...
from itProger.settings import RECIPIENTS_EMAIL
...
def contacti(request):
    model = Message
    template_name = 'blog/contacti.html'
    ...
    if request.method == 'GET':
        ...
        if form.is_valid():
            ...
            try:
                send_mail(subject, message, from_email, [RECIPIENTS_EMAIL])
            ...
            return redirect('blog/contacti.html')
    else:
